...
//   * Native binaries must ship in the plugin: taly-sdk-1.0.1.aar + TalySdk.xcframework
// =============================================================================
...
void main() async {
  ...
  await TalyFlutterSdk.initialize(
    userName:    'DemoMerchant#153',      // your merchant username
    password:    'Dem@Merch@nt#2023',      // your merchant PASSWORD
